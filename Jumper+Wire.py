...
if __name__=='__main__':    
    ...
    freq=np.linspace(1*1e9,12e9, 901)
    eps_r=1
    loss_t=0    
    ...
    # define wires
    wir1=geometry.CoatedWire((0,-d),  ed_coating = 2.8, loss_tan = 0.01)
    wir2=geometry.CoatedWire((0,0),  ed_coating = 2.8, loss_tan = 0.01)
    wir3=geometry.CoatedWire((0,1.08*1e-3),  ed_coating = 2.8, loss_tan = 00.01)
